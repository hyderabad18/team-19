...
public class EventReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder=new AlertDialog.Builder(EventReg.this);
            ...
            public void onClick(View view) {
                ...
                , new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EventReg.this,"error..", Toast.LENGTH_SHORT).show();
                ...
                MySingleton.getInstance(EventReg.this).addTorequestque(stringRequest);
            }
        });
